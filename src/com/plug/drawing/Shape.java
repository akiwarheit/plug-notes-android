...
public abstract class Shape {
  ...
  public Rect getRectWithDefaultMargins(Region region) {
    ...
    rect.set(region.getBounds().left + DEFAULT_MARGIN, region.getBounds().top
        + DEFAULT_MARGIN, region.getBounds().left + region.getBounds().width()
        - DEFAULT_MARGIN, region.getBounds().top + region.getBounds().height()
        - DEFAULT_MARGIN);
    return rect;
  }
