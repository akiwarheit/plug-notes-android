...
/**
 * @author Keendy In loving memory of Dennis Ritchie Thank you for making the
 *         world an easier place. You are the one true brogrammer.
 */
...
public class PlugApplication extends Application {
  ...
  private NotebooksProvider notebookProvider = NotebooksProvider
      .getInstance(this);
