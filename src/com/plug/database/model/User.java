...
public class User {
	...
	@SerializedName("encrypted_password") 				private String encrypted_pass;
	@SerializedName("authentication_token")			  private String auth_token;
	@SerializedName("created_at") 								private String  created_at;
	@SerializedName("current_sign_in_at") 				private String current_sign_in;
	@SerializedName("current_sign_in_IP") 				private String current_sign_in_IP;
	@SerializedName("password_salt")							private String password_salt;
	@SerializedName("last_sign_in_at")						private String last_sign_in_at;
	@SerializedName("last_sign_in_ip")						private String last_sign_in_IP;
	@SerializedName("remember_created_at")				private String remember_created_at;
	@SerializedName("remember_token")							private String remember_token;
	@SerializedName("reset_password_token")				private String reset_password_token;
	@SerializedName("sign_in_count")	            private String sign_in_count;
...
//																								}
	...
	public static void update(Context context, User user, String email, String password) {
		PlugApplication plug = (PlugApplication) context.getApplicationContext();
		UserProvider provider = plug.getUserProvider();
		User currentUser;
